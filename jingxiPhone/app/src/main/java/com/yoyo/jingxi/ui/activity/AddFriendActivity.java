...
public class AddFriendActivity extends AppCompatActivity {
    ...
    private android.widget.Switch switchAllowInteraction;
    ...
    private void startCrop(Uri sourceUri) {
        ...
        Uri destinationUri = Uri.fromFile(new File(getFilesDir(), destinationFileName));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switchAllowInteraction = findViewById(R.id.switchAllowInteraction);
            ...
            Character character = AppDatabase.getDatabase(this).characterDao().getCharacterById(id);
                    if (character != null) {
                        runOnUiThread(() -> {
                            ...
                            // 国籍默认"中国"
                            etNationality.setText(character.nationality != null ? character.nationality : "中国");
                            etLocation.setText(character.location != null ? character.location : "");
                            ...
                            boolean allowInteraction = com.yoyo.jingxi.utils.SpUtils.getBoolean("ALLOW_INTERACTION_" + character.id, true);
                            switchAllowInteraction.setChecked(allowInteraction);
    ...
    private void saveCharacter() {
        ...
        String nationality = etNationality.getText() != null ? etNationality.getText().toString().trim() : "";
        ...
        boolean allowInteraction = switchAllowInteraction.isChecked();
        ...
        // 国籍默认"中国"
        character.nationality = nationality.isEmpty() ? "中国" : nationality;
        ...
        Executors.newSingleThreadExecutor().execute(() -> {
            ...
            com.yoyo.jingxi.utils.SpUtils.putBoolean("ALLOW_INTERACTION_" + id, allowInteraction);
            runOnUiThread(() -> {
