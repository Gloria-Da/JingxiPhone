...
public class AddPersonaActivity extends AppCompatActivity {
    ...
    private CheckBox cbEnableProfile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cbEnableProfile = findViewById(R.id.cbEnableProfile);
        ...
        new Thread(() -> {
            ...
            if (persona != null) {
                runOnUiThread(() -> {
                    ...
                    cbEnableProfile.setChecked(persona.enableProfileExtraction);
    ...
    private void savePersona() {
        ...
        boolean enableProfile = cbEnableProfile.isChecked();
        ...
        new Thread(() -> {
            ...
            persona.enableProfileExtraction = enableProfile;
            persona.avatarPath = currentAvatarUri;

            if (isEditMode) {
                MyPersona existing = db.myPersonaDao().getMyPersonaByName(name);
                if (existing != null) {
                    existing.persona = finalPersonaStr;
                    existing.enableProfileExtraction = enableProfile;
