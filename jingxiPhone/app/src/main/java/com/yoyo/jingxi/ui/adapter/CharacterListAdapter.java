...
public class CharacterListAdapter extends RecyclerView.Adapter<CharacterListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        int layoutRes = useSimpleLayout ? R.layout.item_friend : R.layout.item_chat_list;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvSummary.setText(character.persona);

        // For non-simple lists (e.g. weather character picker), hide unread count and delete button
        if (!useSimpleLayout) {
